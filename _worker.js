...
// Variables
const rootDomain = "laswayne.us.kg"; // Ganti dengan domain utama kalian
const serviceName = "urwyn"; // Ganti dengan nama workers kalian
const apiKey = "bbdf99c7fd8ced33e1612bda99040d1c43f31"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "xlaswayne@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "469eae5334cf95516d3c3215ffd96757"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "d0f239c95c168c11589ed4b5d67eff9f"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
